...
public class chromedesktop extends chromebrowser{
	...
	try
	{
	    ...
	    Thread.sleep(3000);
	    System.out.println("adjusting the resolution of chrome");
	    driver.manage().window().setSize(new Dimension(1920, 1080));
	    System.out.println("Window size set to: " + driver.manage().window().getSize());
	    Thread.sleep(2000);
	    
	    String folder1920 ="/Users/divyabonigala/eclipse-workspace/task1_desktop_testing/Google_Desktop_images/1920X1080";
	...
	try
	{
	    ...
	    String folder1366 ="/Users/divyabonigala/eclipse-workspace/task1_desktop_testing/Google_Desktop_images/1366X768";
		...
		try
		{
		    ...
		    String folder1536 ="/Users/divyabonigala/eclipse-workspace/task1_desktop_testing/Google_Desktop_images/1536X864";
